...
task.spawn(function()
    ...
    while true do
        if levelValue.Value >= 11500 and not triggered then
            triggered = true
            STOP = true
...
local function startScript(char)
    ...
    local function getNearestNPC()
        ...
        for _, npc in pairs(workspace:WaitForChild("NPCs"):GetChildren()) do
            -- Chỉ tìm Swordsman1-5
            if (npc.Name == "Swordsman1" or npc.Name == "Swordsman2" or npc.Name == "Swordsman3" or npc.Name == "Swordsman4" or npc.Name == "Swordsman5") and npc:FindFirstChild("HumanoidRootPart") then
    ...
    task.spawn(function()
        while not STOP do
            ...
            if level >= 1 and level <= 11500 and stat > 0 then
